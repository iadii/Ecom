      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <section>
          ...
          <div className="flex gap-2">
            <input type="email" placeholder="Enter your email" className="flex-1 px-3 py-2 rounded-md border border-[#E5E7EB]" />
            <button className="px-4 py-2 rounded-md text-white" style={{ backgroundColor: '#6C1D57' }}>Subscribe</button>
          </div>
        </section>
      </div>
