...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-50 h-full w-80 bg-[#F5F5F7] shadow-xl transform transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col`}>
